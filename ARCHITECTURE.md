...
**Current count (Phase 15 + alignment fix):** 771/771 non-legacy unit tests passing as of 2026-05-08 (0 failed) + 63 Phase 15 tests + 407 legacy dashboard tests (Phase 12/12.1/14) intentionally skipped via `@pytest.mark.legacy` (4 Whisper integration tests skipped — `openai-whisper` not installed).
